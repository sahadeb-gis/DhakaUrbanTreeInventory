...
# 1. Introduction
This document is a r-script for analysis of the tree data collected from Dhaka North City Corporation (DNCC. Species richness, tree density, basal area, tree cover, phtosociological attributes, diversity indices of the tree species, growing stock, biomass and carbon are the major variables estimated in this r-script. The key parameters were estimated for per strata and land uses.
